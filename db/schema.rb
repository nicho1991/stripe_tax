...
ActiveRecord::Schema[8.0].define(version: 2026_07_14_125155) do
  ...
  create_table "payments", force: :cascade do |t|
    ...
    t.integer "manual_eu_classification"
  ...
  create_table "payouts", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.date "arrival_date"
    t.index ["user_id", "arrival_date"], name: "index_payouts_on_user_id_and_arrival_date"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "stripe_api_key_last4"
    t.string "stripe_api_key_prefix"
    t.string "stripe_account_id"
    t.string "stripe_account_label"
    t.string "stripe_account_country"
    t.string "stripe_account_default_currency"
